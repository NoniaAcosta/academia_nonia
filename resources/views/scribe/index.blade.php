...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/courses/consequatur" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/courses/consequatur"
);
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-courses--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the course. Example: <code>consequatur</code></p>
            </div>
                    </form>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-courses--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the course. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-courses--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the course. Example: <code>consequatur</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-enrollments"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="student_id"                data-endpoint="POSTapi-enrollments"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the students table. Example: <code>17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-enrollments"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
